...
public class SpectrumPane extends JPanel implements IAudio, AlbumReceiver {
	...
	private final int histogramType=3;
	private int deltax;
	private long lastTimeMillis;
	private static final int maxColums = 128;
	private boolean isEnable;
	private final int[] xplot;
	private final int[] lastPeak;
	private final int[] lastY;
	private final BufferedImage spectrumBufferdImage;
	private final BufferedImage barBufferedImage;
	private final Graphics2D spectrumGraphics;
