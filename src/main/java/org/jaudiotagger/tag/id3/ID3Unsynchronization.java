...
public class ID3Unsynchronization
{
    ...
    public static ByteBuffer synchronize(ByteBuffer source)
    {
        ...
        jmp123.Jmp123Logger.infof("Took %6.3f ms, was %d bytes, now %,d bytes%n", time/1e6, source.limit(), bb.limit());
        return bb;
    }
    */
    ...
    public static ByteBuffer synchronize(ByteBuffer source)
    {
        ...
        output.flip();
        long time = System.nanoTime() - start;
        jmp123.Jmp123Logger.infof("Took %6.3f ms, was %d bytes, now %,d bytes%n", time/1e6, source.limit(), output.limit());
        return output;
    }
    */
    ...
    public static ByteBuffer synchronize(ByteBuffer source)
    {
        ...
        //long time = System.nanoTime() - start;
        //jmp123.Jmp123Logger.infof("Took %6.3f ms, was %d bytes, now %,d bytes%n", time/1e6, source.limit(), bb2.limit());
        return bb2;
    }
