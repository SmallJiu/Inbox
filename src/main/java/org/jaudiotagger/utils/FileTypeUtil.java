...
public class FileTypeUtil {
	...
	public static void main(String[] args) throws IOException  {
		// if (args.length < 1) {
		// jmp123.Jmp123Logger.info("Usage: java TestExcelPDF <filename>");
		// System.exit(1);
		// }
		...
		jmp123.Jmp123Logger.info("File type: " + fileType);
		jmp123.Jmp123Logger.info("File Extension: " + getMagicExt(fileType));
	}
}
