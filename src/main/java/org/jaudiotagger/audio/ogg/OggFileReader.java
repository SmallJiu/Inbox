...
public class OggFileReader extends AudioFileReader
{
    ...
    public void summarizeOggPageHeaders(File oggFile) throws CannotReadException, IOException
    {
        ...
        {
            jmp123.Jmp123Logger.info("pageHeader starts at absolute file position:" + raf.getFilePointer());
            OggPageHeader pageHeader = OggPageHeader.read(raf);
            jmp123.Jmp123Logger.info("pageHeader finishes at absolute file position:" + raf.getFilePointer());
            jmp123.Jmp123Logger.info(pageHeader + "\n");
            raf.seek(raf.getFilePointer() + pageHeader.getPageLength());
        }
        jmp123.Jmp123Logger.info("Raf File Pointer at:" + raf.getFilePointer() + "File Size is:" + raf.length());
        raf.close();
    }
