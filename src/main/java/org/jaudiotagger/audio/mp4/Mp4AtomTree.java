    ...
    public void printAtomTree()
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            if (header != null)
            {
                ...
                {
                    jmp123.Jmp123Logger.info(tabbing + "Null pad " + " @ " + header.getFilePos() + " of size:" + header.getLength() + " ,ends @ " + (header.getFilePos() + header.getLength()));                                        
                }
                else
                {
                    jmp123.Jmp123Logger.info(tabbing + "Atom " + header.getId() + " @ " + header.getFilePos() + " of size:" + header.getLength() + " ,ends @ " + (header.getFilePos() + header.getLength()));
                }
            }
        }
    }
