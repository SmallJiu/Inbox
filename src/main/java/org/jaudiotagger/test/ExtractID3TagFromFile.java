...
public class ExtractID3TagFromFile
{
    ...
    public static void main(final String[] args)
    {
        ...
        if (args.length != 2)
        {
            jmp123.Jmp123Logger.error("usage ExtractID3TagFromFile Filename FilenameOut");
            jmp123.Jmp123Logger.error("      You must enter the file to extract the tag from and where to extract to");
            System.exit(1);
        }
        ...
        {
            jmp123.Jmp123Logger.error("usage ExtractID3TagFromFile Filename FilenameOut");
            jmp123.Jmp123Logger.error("      File " + args[0] + " could not be found");
            System.exit(1);
        }
        ...
        {
            jmp123.Jmp123Logger.error("Unable to extract tag");
            System.exit(1);
        }
    }
