...
public final class EmailConfigs {
	...
	public static final BooleanValue Enable_Chat_Button;
	...
	public static class Main extends BaseConfig {
		...
		public final NumberOfWords Number_Of_Words;
		...
		public static class Position extends BaseConfig {
			...
			public static class InboxButtons extends BaseConfig {
				...
				public InboxButtons(Builder builder) {
					super(builder);
					builder.comment("inbox buttons position").push("inbox_buttons");

					this.Chat_Gui_Button = new Pos(builder, "chat_gui_button", 25, 5);
					this.Survival_Gui_Button = new Pos(builder, "survival_gui_button", 27, 9);
					this.Creative_Tab_Button = new Pos(builder, "creative_tab_button", 145, 138);
	...
	static {
		...
		Enable_Chat_Button = builder
				...
				.define("Enable_Chat_Button", true);
