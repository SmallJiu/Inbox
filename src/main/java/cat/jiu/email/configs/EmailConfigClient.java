...
public class EmailConfigClient {
    ...
    public static final ModConfigSpec.BooleanValue Enable_Chat_Button;
    public static final ModConfigSpec.IntValue Email_List_Width;
    public static final ModConfigSpec.BooleanValue Enable_Vanilla_Wrap_Text;
    public static final ModConfigSpec.BooleanValue Lock_Inbox_Button_Dragging;
    public static final Position Position;
    public static final EmailConfigServer.Time Prompt_Email;
    public static final ModConfigSpec.IntValue Send_History_Max_Count;
    ...
    public static class Position extends BaseConfig {
        ...
        Position(ModConfigSpec.Builder builder) {
            super(builder);
        ...
        public static class InboxButtons extends BaseConfig {
            ...
            public final ModConfigSpec.DoubleValue Chat_Gui_Button_Size;
            public final ModConfigSpec.DoubleValue Survival_Gui_Button_Size;
            public final ModConfigSpec.DoubleValue Creative_Tab_Button_Size;

            public InboxButtons(ModConfigSpec.Builder builder) {
                super(builder);
