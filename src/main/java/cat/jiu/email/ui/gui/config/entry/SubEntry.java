...
public class SubEntry extends ConfigEntry<Object> {
    ...
    public SubEntry(String name, ForgeConfigSpec spec, Config config, String path, GuiConfig parent) {
        ...
        this.button = this.addWidget(new GuiButton(0, 0, 300, 20, Component.nullToEmpty(name), btn-> parent.getMinecraft().setScreen(gui)));
        this.button.x = Minecraft.getInstance().getWindow().getGuiScaledWidth()/2 - this.button.getWidth()/2;
