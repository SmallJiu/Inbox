...
public class EmailListWidget extends ObjectSelectionList<EmailListWidget.EmailEntry> {
    ...
    public EmailListWidget(GuiInbox parent, int width, int height, int x, int y) {
        super(Minecraft.getInstance(), width, height, y, parent.getFont().lineHeight * 2 + 8);
        this.parent = parent;
        this.setX(x);
...
//        this.parent.renderListBackground(pGuiGraphics);
        pGuiGraphics.fill(0, 0, this.getRight(), this.getBottom(), 0xC0101010);
    }
