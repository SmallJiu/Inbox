...
public class GuiEmailSend extends AbstractContainerScreen<ContainerEmailSend> {
	public static final ResourceLocation BackGround = ResourceLocation.fromNamespaceAndPath(EmailMain.MODID, "textures/gui/container/inbox_send.png");
	public static final ResourceLocation EXPIRATION = ResourceLocation.fromNamespaceAndPath(EmailMain.MODID, "textures/gui/container/inbox_expiration.png");
	...
	public void init() {
		...
		if (EmailUtils.isOP(Minecraft.getInstance().player)) {
			...
			Button saveItemsBtn = this.addRenderableWidget(new ImageButton(
					...
					15, 12, GuiEmailGenerate.SEND_INV_ITEMS_ICON, button -> {
