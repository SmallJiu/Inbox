...
public class InboxButton {
	public static final ResourceLocation inbox = ResourceLocation.fromNamespaceAndPath(EmailMain.MODID, "textures/gui/inbox_min.png");
	public static final ResourceLocation inbox_hover = ResourceLocation.fromNamespaceAndPath(EmailMain.MODID, "textures/gui/inbox_min_hover.png");
	static final ResourceLocation email = ResourceLocation.fromNamespaceAndPath(EmailMain.MODID, "textures/gui/email.png");
	...
	public static void onGuiMouse(ScreenEvent.MouseScrolled.Pre event) {
		if (INSTANCE != null && INSTANCE.isDragging) {
			INSTANCE.size.set(INSTANCE.size.get() + (event.getScrollDeltaX() > 0 ? 0.05 : -0.05));
	...
	public static class Button extends GuiImageButton {
		...
		protected final ModConfigSpec.DoubleValue size;
		protected boolean isDragging;

		protected long displayTextTime;
		protected Component displayText, displayText1;

		public Button(Screen gui, EmailConfigServer.Pos pos, ModConfigSpec.DoubleValue size, String buttonText) {
