...
public class PlayListThread extends Thread {
	...
	private final ListPane playlist;
	...
	public void deleteSelectedItem() {
		...
		removeSelectedItem();
		try {
//			jmp123.Jmp123Logger.info(filename);
...
//			jmp123.Jmp123Logger.info(item.toString());//##
//			jmp123.Jmp123Logger.info(filename);//##
...
//					playback.getHeader().printHeaderInfo();
		...
		//jmp123.Jmp123Logger.info("jmp123.gui.PlayListThread.run() ret.");
	}
}
